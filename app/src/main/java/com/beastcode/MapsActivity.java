...
public class MapsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefs.edit().putInt("isClicked", 0).apply();
...
/* This code will save your location coordinates in SharedPreference when you click on the map and later you use it  */
                ...
                prefs.edit().putInt("isClicked", 1).apply();
                finish();
...
//        Message.message(this, lng);
     ...
     * installed) and the map has not already been instantiated..  <p/>
